...
| 날짜 | 발표자 | 주차 | CS 주제 | 알고리즘 |
|------|--------|------|---------|----------|
| 1/11 | 용준 | 5주차 | 네트워크 | 二分探索 & スライディングウィンドウ |
| 1/25 | 재엽 | 6주차 | 운영체제 | 二分探索 & スライディングウィンドウ |
| 2/1 | 재엽 | 7주차 | 운영체제 | リンクドリスト |
| 2/8 | 형원 | 8주차 | DB | リンクドリスト |
| 2/15 | 성화 | 9주차 | DB | ツリー & ヒープ |
| 2/22 | 현우 | 10주차 | 디자인패턴 | ツリー & ヒープ |
| 3/1 | 용준 | 11주차 | 디자인패턴 | グラフ & バックトラッキング |
| 3/8 | - | 12주차 | 총정리 | グラフ & バックトラッキング |

**남은 알고리즘:** 動的計画法(DP), 高度なトピック & 応用
