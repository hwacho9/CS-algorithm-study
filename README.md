...
| ----- | ------------- | --------- | ---- |
| 조성화(알고) |    hwacho9           | -         | 일본대학 유학생(26졸), 전공생   |
| 안현우(알고) |               | -         | -    |
| 이재엽(알고) |               | -         | -    |
| 장형원(알고) |               | -         | -    |
| 허용준 |               | -         | -    |
...
| 기간   | 대주제       | 주차별 세부 주제                                                                                                                                                                                                 |
| ------ | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1–3주  | 자료구조     | • 1주: 시간복잡도(Big-O), 배열, 연결 리스트, 스택, 큐(재엽님)<br>• 2주: 해시 테이블(충돌 해결 방법 포함), 트리, 힙<br>• 3주: 그래프(DFS/BFS 기본 탐색), 각 자료구조별 시간복잡도 총정리표 및 실습 |
